...
checkbutton_lower_var = IntVar(value=1)
checkbutton_numbers_var = IntVar(value=1)
checkbutton_symbols_var = IntVar(value=1)
...
checkbutton_upper = Checkbutton(master=right_frame, text='Uppercase', variable=checkbutton_upper_var, offvalue=0, onvalue=1, command=lambda: make_1_checkbutton_always_active(checkbutton_upper_var))
checkbutton_lower = Checkbutton(master=right_frame, text='Lowercase', variable=checkbutton_lower_var, offvalue=0, onvalue=1, command=lambda: make_1_checkbutton_always_active(checkbutton_lower_var))
checkbutton_numbers = Checkbutton(master=right_frame, text='Numbers', variable=checkbutton_numbers_var, offvalue=0, onvalue=1, command=lambda: make_1_checkbutton_always_active(checkbutton_numbers_var))
checkbutton_symbols = Checkbutton(master=right_frame, text='Symbols', variable=checkbutton_symbols_var, offvalue=0, onvalue=1, command=lambda: make_1_checkbutton_always_active(checkbutton_symbols_var))
